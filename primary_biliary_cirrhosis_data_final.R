...
## ---- message = FALSE, warning = FALSE, echo = FALSE, fig.cap="Explanation of variables in the dataset"--------------------------------------------------------------------
...
## ----fig.cap= "Number of NA values in for the 312 study patients", message = FALSE, comment=FALSE,warning=FALSE, echo = FALSE----------------------------------------------
...
## ----fig.cap = "Histogram of continous variables" , warnings = FALSE, message = FALSE, echo = FALSE------------------------------------------------------------------------
...
## ----fig.cap= "Boxplot of continous variables", message = FALSE, warning = FALSE, echo = FALSE-----------------------------------------------------------------------------
...
## ----fig.cap= "Boxplot of log2() transformed continous variables", message = FALSE, warning = FALSE, echo = FALSE----------------------------------------------------------
...
## ----fig.cap= "Quantile-quantile plot of log2() transformed features", message = FALSE, warning = FALSE, echo = FALSE------------------------------------------------------
...
## ---- fig.cap = "Barplot of categorical features", message = FALSE, warning = FALSE, echo = FALSE--------------------------------------------------------------------------
...
## ---- fig.cap= "Spearman correlation between features", message = FALSE, warning = FALSE, echo = FALSE---------------------------------------------------------------------
...
## ----fig.cap = "Survival curve of all available PBC patients", message = FALSE, warning = FALSE, echo = FALSE--------------------------------------------------------------
...
## ---- fig.cap = "Survival curve stratified by presence or absence of ascites"----------------------------------------------------------------------------------------------
...
## ----fig.cap = "Nomogramm of fitted elastic net model", echo=FALSE, warning = FALSE, message=FALSE, comment=FALSE----------------------------------------------------------
...
## ----fig.cap="Uno's time dependent AUC in training data", echo = FALSE, message=FALSE, warning=FALSE-----------------------------------------------------------------------
...
## ----fig.cap="Internal calibration plot at 3 years", echo = FALSE, message = FALSE, warning = FALSE------------------------------------------------------------------------
...
## ----fig.cap = "External calibration plot at 3 years", echo = FALSE, message = FALSE, warning = FALSE----------------------------------------------------------------------
# compute calibration
...
## ----fig.cap = "Kaplan Meier curves of the training data, stratified into three risk groups", echo = FALSE, message = FALSE, warning = FALSE-------------------------------
...
## ----fig.cap = "Kaplan Meier curves of the test data, stratified into three risk groups", echo = FALSE, message = FALSE, warning = FALSE-----------------------------------
...
## ----fig.cap = "Variable importance of the random survival forest", echo = FALSE, message = FALSE, warning = FALSE---------------------------------------------------------
plot(gg_vimp(rsf_1))
